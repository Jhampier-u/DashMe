...
' tarea corre en la sesion interactiva: sin esto aparece una ventana negra cada
' 20 minutos. La solucion nativa -- "ejecutar tanto si el usuario inicio sesion
' como si no" -- exige permisos de administrador que el usuario normal no
' tiene.
'
