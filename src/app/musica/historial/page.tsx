...
import { getMe, parseRange, resolveTimeZone, getHistory } from "@/modules/musica";
...
function enlace(
  ...
  const q = p.toString();
  return q ? `/musica/historial?${q}` : "/musica/historial";
}
  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section className="px-8 py-5 hairline-b">
        <RangePicker range={range} base="/musica/historial" />
      </section>
              ...
              return (
                <li key={r.id}>
                  ...
                  <div className="flex items-baseline gap-4 py-1.5 hairline-b">
                    ...
                    <span className="label-mono text-mute num-tabular shrink-0">
